...
TEST(try_parse_message, produces_correct_lengths)
{
    ...
    {
        { std::string{ 0x00 }, 1, 0 },
        { std::string{ 0x03, 0x41, 0x42, 0x43 }, 1, 3 },
        { std::string{ 0x0B, 0x41, 0x0A, 0x52, 0x0D, 0x43, 0x0D, 0x0A, 0x3B, 0x44, 0x45, 0x46 }, 1, 11 },
        { std::string{ (char)0x80, 0x01, // Size - 128
                ...
                0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77, 0x78, 0x79, 0x7a, 0x7b, 0x7c, 0x7d, 0x7e, 0x7f}, 2, 128 },
    };
