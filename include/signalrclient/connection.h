...
namespace signalr
{
    ...
    public:
        ...
        SIGNALRCLIENT_API explicit connection(const std::string& url, std::shared_ptr<scheduler> scheduler, trace_level trace_level = trace_level::all, std::shared_ptr<log_writer> log_writer = nullptr);
