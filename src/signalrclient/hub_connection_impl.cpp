...
namespace signalr
{
    ...
    {
        auto connection = std::shared_ptr<hub_connection_impl>(new hub_connection_impl(url, scheduler, trace_level, log_writer, http_client, websocket_factory, skip_negotiation));
